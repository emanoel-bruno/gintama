$(document).ready(function() {
    ...
    $('.js--scroll-to-plans').click ( () => {
        $('html, body').animate({scrollTop: $('.js--section-server').offset().top},1000);
    }); 
    ...
    $(".js--wp-features").waypoint({
        handler: function(direction) {
            if(direction == 'down'){ $(".js--wp-features").addClass("animated fadeIn"); }
        }, offset: '60%'
    });

    $(".js--wp-app").waypoint({
        handler: function(direction) {
            if(direction == 'down'){ $(".js--wp-app").addClass("animated fadeInUp"); }
        }, offset: '120%'
    });

    $(".js--wp-cities").waypoint({
        handler: function(direction) {
            if(direction == 'down'){ $(".js--wp-cities").addClass("animated fadeIn"); }
        }, offset: '40%'
    });

    $(".js--wp-saiko").waypoint({
        handler: function(direction) {
            if(direction == 'down'){ $(".js--wp-saiko").addClass("animated pulse"); }
        }, offset: '20%'
    });
